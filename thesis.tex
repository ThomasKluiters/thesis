...
\author{Thomas Kluiters}                               % CHANGE TO YOUR NAME
\authoremail{\url{thomas.kluiters@protonmail.com}}       % CHANGE TO YOUR EMAIL ADDRESS
\birthplace{Cappelle Aan Den IJssel, Nederland}                % CHANGE TO YOUR BIRTH PLACE
...
\include{chapters/considerations.tex}
